...
const fonts = [
  ...
  ["Outfit", 800, "normal", "100%"],
  ["Turret Road", 800, "normal", "100%"],
  ["Archivo", 900, "normal", "125%"],
];
const q = "family=Aldrich&family=Space+Grotesk:wght@700&family=Unbounded:wght@800&family=Oswald:wght@600&family=Outfit:wght@800&family=Turret+Road:wght@800&family=Archivo:wdth,wght@125,900";
