...
export function Logo() {
  ...
  return (
    <TransitionLink href="/" aria-label={`${PROFILE.firstName} ${PROFILE.lastName} — ${t.a11y.home}`} data-fill className="group flex items-center gap-3">
      <span className="grid size-9 place-items-center border border-line-strong text-fg transition-colors duration-200 group-hover:border-accent group-hover:bg-accent group-hover:text-on-accent">
